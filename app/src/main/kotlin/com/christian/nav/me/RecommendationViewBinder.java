...
public class RecommendationViewBinder extends ItemViewBinder<Recommendation, RecommendationViewBinder.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        return new ViewHolder(inflater.inflate(com.christian.R.layout.about_page_item_recommendation, parent, false), activity);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, @NonNull AbsAboutActivity activity) {
            super(itemView);
            this.activity = activity;
            icon = itemView.findViewById(com.christian.R.id.icon);
            name = itemView.findViewById(com.christian.R.id.name);
            packageName = itemView.findViewById(com.christian.R.id.packageName);
            sizeView = itemView.findViewById(com.christian.R.id.size);
            description = itemView.findViewById(com.christian.R.id.description);
            itemView.setOnClickListener(this);
        }

        @Override
        public void onClick(View v) {
            if (v.getId() == com.christian.R.id.google_play && bottomSheet != null) {
                openWithMarket(v.getContext(), recommendation.packageName, recommendation.downloadUrl);
                bottomSheet.dismiss();
            } else if (v.getId() == com.christian.R.id.web && bottomSheet != null) {
                ...
                if (recommendation.openWithGooglePlay) {
                    ...
                    bottomSheet.setContentView(com.christian.R.layout.about_page_dialog_market_chooser);
                    bottomSheet.show();
                    // noinspection ConstantConditions
                    bottomSheet.findViewById(com.christian.R.id.web).setOnClickListener(this);
                    // noinspection ConstantConditions
                    bottomSheet.findViewById(com.christian.R.id.google_play).setOnClickListener(this);
                } else {
                    openWithWeb(v.getContext(), recommendation);
                }
            }
