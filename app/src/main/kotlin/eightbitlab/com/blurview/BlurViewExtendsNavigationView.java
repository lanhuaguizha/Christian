 ...
 */
public class BlurViewExtendsNavigationView extends NavigationView {

    private static final String TAG = BlurViewExtendsNavigationView.class.getSimpleName();
    ...
    public BlurViewExtendsNavigationView(Context context) {
        super(context);
        init(null, 0);
    }

    public BlurViewExtendsNavigationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BlurViewExtendsNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return {@link BlurViewExtendsNavigationView} to setup needed params.
     */
