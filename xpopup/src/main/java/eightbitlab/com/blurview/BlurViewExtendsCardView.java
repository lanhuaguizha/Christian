 ...
 */
public class BlurViewExtendsCardView extends CardView {

    private static final String TAG = BlurViewExtendsCardView.class.getSimpleName();
    ...
    public BlurViewExtendsCardView(Context context) {
        super(context);
        init(null, 0);
    }

    public BlurViewExtendsCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BlurViewExtendsCardView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return {@link BlurViewExtendsCardView} to setup needed params.
     */
