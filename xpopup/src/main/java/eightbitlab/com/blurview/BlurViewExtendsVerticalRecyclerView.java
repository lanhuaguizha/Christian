 ...
 */
public class BlurViewExtendsVerticalRecyclerView extends VerticalRecyclerView {

    private static final String TAG = BlurViewExtendsVerticalRecyclerView.class.getSimpleName();
    ...
    public BlurViewExtendsVerticalRecyclerView(Context context) {
        super(context);
        init(null, 0);
    }

    public BlurViewExtendsVerticalRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BlurViewExtendsVerticalRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return {@link BlurViewExtendsVerticalRecyclerView} to setup needed params.
     */
